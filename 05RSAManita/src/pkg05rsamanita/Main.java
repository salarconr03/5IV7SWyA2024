...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Mensaje a cifrar
        String mensajeOriginal = "El sake de binks sera lo que vamos a entregar ni el viento la marea nos podra parar";

        // Crear una instancia de la clase Main (la misma clase)
        Main rsa = new Main(tamprimo);
        ...
        // Cifrar el mensaje
        BigInteger[] mensajeCifrado = rsa.cifrar(mensajeOriginal);
